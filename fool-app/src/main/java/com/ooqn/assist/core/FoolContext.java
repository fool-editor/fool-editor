...
public class FoolContext {
    ...
    private static ComponentManage componentManage = new ComponentManage();
    ...
    public static ComponentManage getComponentManage() {
    ...
    public static void setComponentManage(ComponentManage moduleManage) {
        FoolContext.componentManage = moduleManage;
    }
